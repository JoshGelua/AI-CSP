...
if __name__ == "__main__":
    ...
    if test_ord_lcv:
        ...
        map_2_CSP = CSP("Map2", [a2,b2])
        c12 = Constraint("WA_NT",[a2,b2])
        c12.add_satisfying_tuples([(1,2),(1,3),(2,3)])

        map_2_CSP.add_constraint(c12)
        ...
        if vals:
            ...
            print("No Values Returned from val_lcv")
        ...
        map_2_CSP = CSP("Map2", [a2,b2,c2])
        c12 = Constraint("WA_NT",[a2,b2])
        c12.add_satisfying_tuples([(1,2),(1,3),(2,3)])
        map_2_CSP.add_constraint(c12)

        c13 = Constraint("WA_SA",[a2,c2])
        c13.add_satisfying_tuples([(1,3),(1,4)])
        map_2_CSP.add_constraint(c13)
